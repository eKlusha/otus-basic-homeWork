package ru.otus.basic.homework.homework2;
...
//        changeArrays(array3, newArray3, a);  //не получилось через через System.arraycopy сделать :/
//        changeArrays(array4, newArray4, a);
//        changeArrays(array5, newArray5, a);
